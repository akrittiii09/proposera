...
7. **Public Creator Signup Without Paywall (DEC-011 / Q1)**: Creators may publicly sign up. Proposal authoring and live publishing are directly available without payment. Proposera MVP has NO paywall; Razorpay is not required for publishing. *(Source: Owner Decision Q1)*
